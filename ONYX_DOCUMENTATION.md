...
@Nishant is the responsible person for Tailscale — contact him if you are not connected yet or need an invite.
...
Open your browser and navigate to: `http://10.0.1.169:3000`
...
- Additional sources can be added as needed by admins
...
Onyx supports configuring specialized **assistants** (personas) with pre-set instructions and document scope. If your team has a specific assistant configured (e.g. a project-scoped bot), you can select it from the **Assistants** dropdown in the Chat view.
...
While you work in Claude Code, Claude searches Onyx in the background when your question sounds internal. You can also trigger a search explicitly by typing things like:
...
- Ana-Maria Lacatusu — a.lacatusu@reply.de
- Korbinian Hörmann — k.hoermann@reply.de

**Tailscale Admin:**

- Nishant — contact for VPN access and Tailscale invitations

**Who to contact for what:**

- Can't log in / account access → Onyx Admin
- New connector needed / project not indexed → Onyx Admin
- Can't connect via Tailscale / need Tailscale invite → Nishant
